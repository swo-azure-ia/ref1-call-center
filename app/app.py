...
def callcenter():
    ...
    try:
        ...
        # myCredential = DefaultAzureCredential(exclude_shared_token_cache_credential=True)
...
def token():
    try:
        ...
        azure_token = DefaultAzureCredential(exclude_shared_token_cache_credential=True).get_token("https://cognitiveservices.azure.com/.default")
...
def sentiment():
    try:
        ...
        global text_analytics_client
        myCredential = DefaultAzureCredential(exclude_shared_token_cache_credential=True)
        text_analytics_client = TextAnalyticsClient(endpoint, credential=myCredential)
